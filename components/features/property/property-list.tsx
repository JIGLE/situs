...
export const PropertiesView = forwardRef<PropertiesViewRef, PropertiesViewProps>(
  function PropertiesView(
    ...
    // The Portfolio commits to the tree + workspace (mockup-faithful) — no view toggle.
    ...
    const handleTreeSelect = useCallback(
      ...
      [openPropertyDetail, onPropertySelect],
    );
    ...
    useEffect(() => {
      ...
      const handleChange = (e: MediaQueryListEvent) => {
        if (!e.matches) {
          openPropertyDetail(workspacePropertyId);
          setWorkspacePropertyId(null);
        }
      };
      mql.addEventListener("change", handleChange);
      return () => mql.removeEventListener("change", handleChange);
    }, [workspacePropertyId, openPropertyDetail]);
