...
const leaseFields = z.object({
  ...
  // Spelled as the wizard's Select, the demo seed and the tax calculator spell it; nullable because
  // a lease created without a regime stores null, and editing it sends that null back.
